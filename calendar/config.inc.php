...
// backend type ("database", "kolab", "caldav", "ical", "ldap") - Be sure and import the appropriate driver sql schema to your database to use
...
$config['calendar_agenda_range'] = 180;
...
$config['calendar_default_alarm_type'] = 'DISPALY';
...
$rcmail_config['kolab_invitation_calendars'] = false;
...
// %n - Calendar name
// %i - Calendar UUID
$config['calendar_caldav_url'] = 'https://www.mint70.com/sandbox/cloud/remote.php/remote.php/dav/calendars/%u/%n';
